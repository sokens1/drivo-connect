...
import { Mail, Phone, MapPin, Send, MessageCircle, Car } from "lucide-react";
                ...
                <CardContent className="p-6">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <a href="tel:+24177000000" className="text-muted-foreground hover:text-primary">
                        +241 77 00 00 00
                      </a>
                    </div>
                  </div>
                ...
                <CardContent className="p-6">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <a href="mailto:contact@drivo.ga" className="text-muted-foreground hover:text-primary">
                        contact@drivo.ga
                      </a>
                    </div>
                  </div>
