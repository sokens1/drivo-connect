...
const AddVehiclePage = () => {
    ...
    // Reuse existing vehicles as "other vehicles" list
        ...
        <div className="h-[calc(100vh-80px)] overflow-hidden flex flex-col md:flex-row gap-6">
            ...
            <div className="flex-1 flex flex-col h-full overflow-hidden bg-background rounded-lg border shadow-sm">
                ...
                <div className="flex-1 overflow-y-auto p-6">
                    <form id="add-vehicle-form" onSubmit={handleSubmit} className="space-y-6 max-w-2xl mx-auto">

                        {/* Image Upload Placeholder */}
                        <div className="border-2 border-dashed rounded-xl p-8 flex flex-col items-center justify-center text-muted-foreground hover:bg-muted/50 transition-colors cursor-pointer">
